<template>
  ...
  <p>
    The number of IPv6 addresses per square meter of the Earth's surface is
    then:
  </p>
  ...
  <p>
    Interestingly, this number is close to the
  ...
  <p>
    then each atom on the Earth's surface could have thousands of unique IPv6
